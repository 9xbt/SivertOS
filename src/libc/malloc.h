...
struct S_MEMORY_PEBBLE {
  u32 magic;         // a pebble in a bucket
  u32 lflags;        // local flags for this pebble
  u32 sflags;        // sent flags for this pebble
  u32 padding;       // padding/alignment
...
struct S_MEMORY_BUCKET {
  u32 magic;     //  a bucket full of pebbles
  u32 lflags;    //  local flags for this bucket
...
void *kmalloc(size_t size, u64 alignment, u32 flags, char *name);
